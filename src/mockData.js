...
export const mockResponse = {
  ...
  trust: {
    ...
    level: 'success',
    score: 0.92,
    reason: '命中 3 条监管原文，证据均来自正式制度文件，关键数字可追溯。'
  },
  answer:
    '商业银行应持续满足资本充足率监管要求，并按监管口径识别核心一级资本、一级资本和资本净额。系统建议在正式申报或业务解释时，以最新监管文件原文为准，并同时核对适用机构类型和报表口径。',
  evidence: [
    {
      id: 'EV-001',
      title: '商业银行资本管理办法',
  ...
  retrievalSteps: [
    { title: '解析问题', detail: '识别主题：资本充足率；问题类型：监管事实问答。' },
    { title: '召回候选段落', detail: '从制度 PDF、报表 Excel、流程 Word 中召回 18 个片段。' },
    { title: '证据重排', detail: '按语义相似度、来源权威性、数字命中情况筛选前 3 条。' },
    { title: '生成回答', detail: '仅基于证据生成答案，并保留拒答判断。' }
  ]
};

export const documents = [
  { name: '商业银行资本管理办法.pdf', type: 'PDF', chunks: 128, status: '已入库' },
  { name: 'G40资本充足率汇总表.xlsx', type: 'Excel', chunks: 46, status: '已入库' },
  { name: '监管统计填报说明.docx', type: 'Word', chunks: 73, status: '解析中' }
];
